...
<div class="row">
    <div class="col-lg-6 mb-3">
        <form action="{{ route('resumes.recherche') }}" method="get">
            @csrf
            <div class="input-group">
                <input type="text" name="designation" id="rechercheResume" class="form-control" placeholder="Rechercher par titre du résumé">
                            ...
                            <tr>
                                <td>
                                    <a href="/resumes/show/{{ $resumes->token }}" class="table-link">
                                        <i class="fas fa-book"></i> {{ "- ".$resumes->designation}}
                                    </a>
                                </td>
                            </tr>
                            @endforeach
