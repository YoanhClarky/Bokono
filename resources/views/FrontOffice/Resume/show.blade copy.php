        ...
        <div class="container-fluid mt-4 mb-4">
            <div class="row tm-mb-7 justify-content-center">
                <div class="col-lg-8">
                    ...
                    <div class="card">
                        <!-- Image du livre -->
                        <img src="chemin_de_l_image_du_livre.jpg" class="card-img-top" alt="Image du Resume">
        
                        <!-- Contenu de la carte -->
                        <div class="card-body">
                            <!-- Titre du livre -->
                            <h5 class="card-title">{{ $resume->cour->designation }}</h5>
        
                            <!-- Description du livre -->
                            <p class="card-text">{{ $resume->cour->description }}Une brève description du livre va ici. Vous pouvez ajouter des détails importants sur le livre.</p>
                            @php
                            $timestamp = time();
                            @endphp
                            <!-- Bouton de téléchargement -->
                            <a href="{{ url('resume/telecharger/' . $resume->id) }}" download="{{$timestamp}}.pdf" class="btn btn-primary mt-2">Télécharger le PDF</a>
                        </div>
                    </div>
