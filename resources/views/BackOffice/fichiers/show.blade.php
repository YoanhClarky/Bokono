...
<body>
    ...
    <h1>TABLEAU DE BORD/ <span id="telechargement-info" style="color:rgb(156, 155, 155)"></span></h1>
                            ...
                            <div class="col-lg-3 col-sm-6 mb-lg-0 mb-5 fichier-item" style="border-style:ridge;border-radius:25px; margin:5px; box-shadow: 0px 3px 4px 3px rgba(0, 0, 0, 0.2);">
                                ...
                                <div class="section">
                                    ...
                                    <div class="monographie-container" style="margin-bottom: 10px;">
                                        @if ($fichier->etat != 0)
                                        <a href="/disable/{{$fichier->id}}" class="btn btn-success mt-2">Actif</a>
                                        <a href="/delete/{{$fichier->id}}" class="btn btn-danger mt-2">Supprimer</a>
                                        @else
                                        <a href="/enable/{{$fichier->id}}" class="btn btn-danger mt-2">Inactif</a>
                                        <a href="/delete/{{$fichier->id}}" class="btn btn-danger mt-2">Supprimer</a>
                                        @endif
                                    </div>
                                </div>
