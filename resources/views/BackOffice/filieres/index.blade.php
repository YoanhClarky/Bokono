    ...
    <div class="tm-container bg-white">
        ...
        <div class="container-fluid mt-4 mb-4">
            <div class="row tm-mb-7 justify-content-center">
                <div class="col-lg-12">
                    <div class="row tm-mb-14">
                        <form action="/filiere/create" method="post">
                            @csrf
                            <div class="col-lg-12">
                                <label for="">Designation</label>
                                 <input required name="designation" type="text" placeholder="designation de la filière"><br>
                                 <label for="">Code</label>
                                 <input required name="code" type="text" placeholder="code de la filière">
                                </div>
                                <div class="col-lg-12">
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                            <td>
                            <a href="/filiere/show/{{ $item->id}}" class="table-link">
                                <i class="fas fa-book"></i> {{ " - ".$item->designation." ".$item->code}}
                            </a>
                            @if($item->etat)
                                <a class="btn btn-success" href="/filiere/desactiver/{{ $item->id }}">Est actif</a>
                            @else
                            <a class="btn btn-danger" href="/filiere/activer/{{ $item->id }}">Est inactif</a>
                            @endif
                            <a class="btn btn-danger" href="/filiere/supprimer/{{ $item->id }}">Supprimer</a>
                            </td>
                            <tr>
                                @endforeach
