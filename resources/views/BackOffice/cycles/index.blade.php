            ...
            <div class="row tm-mb-7 justify-content-center">
                <div class="col-lg-12">
                    <div class="row tm-mb-14">
                        <form action="/cycle/create" method="post">
                            @csrf
                            <div class="col-lg-12">
                                <label for="">Designation</label>
                                 <input required name="designation" type="text" placeholder="designation du cycle"><br>
                                 <label for="">Code</label>
                                 <input required name="code" type="text" placeholder="code du cycle">
                                </div>
                                <div class="col-lg-12">
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                            <td>
                            <a href="/cycle/show/{{ $item->id}}" class="table-link">
                                <i class="fas fa-book"></i> {{ " - ".$item->designation." ".$item->code}}
                            </a>
                            @if($item->etat)
                                <a class="btn btn-success" href="/cycle/desactiver/{{ $item->id }}">Est actif</a>
                            @else
                            <a class="btn btn-danger" href="/cycle/activer/{{ $item->id }}">Est inactif</a>
                            @endif
                            <a class="btn btn-danger" href="/cycle/supprimer/{{ $item->id }}">Supprimer</a>
                            </td>
                            <tr>
                                @endforeach
