    ...
    <div class="tm-container bg-white">
        ...
        <div class="container-fluid mt-4 mb-4">
            <div class="row tm-mb-7">
                <form action="/cycle/update/{{ $cycle->id }}" method="post">
                    @csrf
                    <div class="col-lg-12">
                        <label for="">Designation</label>
                         <input required name="designation" type="text" value="{{ $cycle->designation }}"><br>
                         <label for="">Code</label>
                         <input required name="code" type="text" value="{{ $cycle->code }}"><br>
                        </div>
                        <div class="col-lg-12">
