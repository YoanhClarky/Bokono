                ...
                <div class="col-lg-12">
                    <div class="container mt-3">
                        <div class="row justify-content-center">
                            <div class="col-lg-10">
                                <form action="{{ route('cour.update', ['id' => $item->id]) }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-group">
                                    <label for="cour_id">Description</label>
                                    <textarea class="form-control" name="description" id="description" cols="30" rows="10">{{ $item->cour->description }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label for="cycle_id">Cycle</label>
                                    <select class="form-control" name="cycle_id" required>
                                        <option value="{{ $item->cycle->id }}">{{ $item->cycle->designation }}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="type_id" required>
                                        <option value="{{ $item->type->id }}">{{ $item->type->designation }}</option>
