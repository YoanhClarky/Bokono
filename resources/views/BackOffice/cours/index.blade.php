            ...
            <div class="row tm-mb-7 justify-content-center">
                <div class="col-lg-12">
                    <div class="container mt-3">
                        <div class="row justify-content-left" style="padding-bottom: 5px">
                            <a class="btn btn-primary" href="/dashboard/cour/creation">NOUVEAU COUR</a>
                        </div>
                    </div>
                </div>
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr class="small-row"> <!-- Ajoutez une classe pour les lignes de tableau plus petites -->
                            <td>
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <a href="/dashboard/cour/show/{{ $item->token }}" class="table-link">
                                    ...
                                    <div>
                                        @if($item->etat)
                                            <a class="btn btn-success btn-xs" href="/dashboard/cour/desactiver/{{ $item->token }}">
                                                <i class="fas fa-check"></i> Est actif
                                            </a>
                                        @else
                                            <a class="btn btn-warning btn-xs" href="/dashboard/cour/activer/{{ $item->token }}">
                                                <i class="fas fa-times"></i> Est inactif
                                            </a>
                                        @endif
                                    
                                        <a class="btn btn-danger btn-xs" href="/dashboard/cour/supprimer/{{ $item->token }}">
