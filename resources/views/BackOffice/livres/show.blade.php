                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input value="{{ $livre->titre }}" required name="titre" type="text" class="form-control" id="titre" placeholder="Titre du livre">
                                            </div>
                                            <div class="form-group">
                                                <label for="soustitre">Sous-titre</label>
                                                <input value="{{ $livre->soustitre }}" required name="soustitre" type="text" class="form-control" id="soustitre" placeholder="Sous-Titre">
                                            </div>
                                            <div class="form-group">
                                                <label for="auteur">Auteur</label>
                                                <input value="{{ $livre->auteur }}" required name="auteur" type="text" class="form-control" id="auteur" placeholder="Auteur">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="edition">Edition</label>
                                                <input value="{{ $livre->edition }}" required name="edition" type="text" class="form-control" id="edition" placeholder="Edition">
                                            </div>
                                            <div class="form-group">
                                                <label for="lieupub">Lieu de publication</label>
                                                <input value="{{ $livre->lieupub }}" name="lieupub" type="text" class="form-control" id="lieupub" placeholder="Lieu de publication">
                                            </div>
                                            <div class="form-group">
                                                <label for="maisoned">Maison d'édition</label>
                                                <input value="{{ $livre->maisoned }}" name="maisoned" type="text" class="form-control" id="maisoned" placeholder="Maison d'édition">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="datepub">Date de publication</label>
                                                <input value="{{ $livre->datepub }}" type="date" name="datepub" class="form-control" id="datepub" placeholder="Date de publication">
                                            </div>
                                            <div class="form-group">
                                                <label for="page">Nombre de pages</label>
                                                <input value="{{ $livre->page }}" type="number" name="page" class="form-control" id="page" placeholder="Nombre de pages">
                                            </div>
                                            <!-- Colonne pour le fichier PDF -->
                                            <div class="form-group">
