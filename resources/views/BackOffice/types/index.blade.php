                ...
                <div class="col-lg-12">
                        ...
                        <form action="/type/create" method="post">
                            ...
                            <div class="col-lg-12">
                                <label for="">Designation</label>
                                 <input required name="designation" type="text" placeholder="designation du type"><br>
                                </div>
                                <div class="col-lg-12">
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                            <td>
                            <a href="/type/show/{{ $item->id}}" class="table-link">
                                <i class="fas fa-book"></i> {{ " - ".$item->designation}}
                            </a>
                            @if($item->etat)
                                <a class="btn btn-success" href="/type/desactiver/{{ $item->id }}">Est actif</a>
                            @else
                            <a class="btn btn-danger" href="/type/activer/{{ $item->id }}">Est inactif</a>
                            @endif
                            <a class="btn btn-danger" href="/type/supprimer/{{ $item->id }}">Supprimer</a>
                            </td>
                            <tr>
                                @endforeach
